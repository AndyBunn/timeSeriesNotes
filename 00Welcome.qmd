...
This document was written in Markdown using quarto and built with **R version `r getRversion()`**. You should be reasonably up to date on your versions of R, RStudio, and relevant packages. You can update your packages by running:
