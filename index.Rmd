...
This document was written in Markdown using the **bookdown** package and built with **R version `r getRversion()`**. You should be up to date — or at least close — on your versions of R, RStudio, and relevant packages. You can keep your packages updated by running:
